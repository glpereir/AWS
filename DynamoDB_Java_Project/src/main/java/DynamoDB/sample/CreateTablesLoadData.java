...
public class CreateTablesLoadData {
    ...
    static String productCatalogTableName = "ProductCatalogGP";
    static String forumTableName = "ForumGP";
    static String threadTableName = "ThreadGP";
    static String replyTableName = "ReplyGP";
